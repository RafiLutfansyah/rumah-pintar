                ...
                <div className="footer-top-item lab-item">
                  <div className="lab-inner">
                    ...
                    <div className="lab-content">
                      <span>Nomor Telepon : 087780287810</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-sm-6 col-12">
                <div className="footer-top-item lab-item">
                  <div className="lab-inner">
                    ...
                    <div className="lab-content">
                      <span>Email : dika@rumahpintar.com</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-sm-6 col-12">
                <div className="footer-top-item lab-item">
                  <div className="lab-inner">
                    ...
                    <div className="lab-content">
                      <span>Alamat : Bakti Jaya, Setu, Tang-Sel</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-12">
                <div className="footer-bottom-content text-center">
                  <p>
                    ©2022 <Link href="/">Rumah Pintar</Link> - Best for Smart Home.
                  </p>
                </div>
              </div>
            </div>
